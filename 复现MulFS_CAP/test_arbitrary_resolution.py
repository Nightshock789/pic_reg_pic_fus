...
vis_test_dir = r"P:\pic_reg_and_pic_fus\learning\MulFS-CAP\vis_dir"
ir_test_dir = r"P:\pic_reg_and_pic_fus\learning\MulFS-CAP\ir_dir"

save_dir = "./results"
#save_ird_dir = save_dir + "/ird"
save_fusion_dir = save_dir + "/fusion"
save_ir_dir=r'P:\pic_reg_and_pic_fus\learning\MulFS-CAP\ir_dir'
utils.check_dir(save_dir)
utils.check_dir(save_ir_dir)
...
pretrain_dir = r"P:\pic_reg_and_pic_fus\learning\MulFS-CAP\pretrained"
...
for x in tqdm(test_data_iter):
    ...
    with torch.no_grad():
        ...
        if h % 16 != 0 or w % 16 != 0:
                vis = F.interpolate(vis, (h, w), mode="bilinear", align_corners=False)
                ir_d = F.interpolate(ir_d, (h, w), mode="bilinear", align_corners=False)
                fusion_image_sample = F.interpolate(fusion_image_sample, (h, w), mode="bilinear", align_corners=False)
        ...
        output_name = save_ir_dir + "/" + file_name + ".png"
